...
<head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/assets/JS/statistics/statisticsProject.js"></script>
</head>
<body>
<%
...
<input id="Pmoneyjson" value=<%=Pmoney%> class="hide">
...
<div class="container-fluid">
    <div class="row">
        <div id="project_bar" class="col-md-6" style="height:400px"></div>
        <div id="project_pie" class="col-md-5 col-md-offset-1" style="height:400px"></div>
    </div>
</div>
<div class="container-fluid">
    <div class="row">
        <div id="pmoney_bar" class="col-md-6" style="height:400px"></div>
        <div id="pmoney_pie" class="col-md-5 col-md-offset-1" style="height:400px"></div>
    </div>
</div>

<div class="container-fluid">
    <div class="row">
        <div id="project_broken_line" class="col-md-12" style="height:400px"></div>
    </div>
</div>
