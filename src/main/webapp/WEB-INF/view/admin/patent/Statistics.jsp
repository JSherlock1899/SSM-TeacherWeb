...
<head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/assets/JS/statistics/statisticsPatent.js"></script>
</head>
<body>
<%
...
<div class="container-fluid">
    <div class="row">
        <div id="patent_bar" class="col-md-6" style="height:400px"></div>
        <div id="patent_pie" class="col-md-5 col-md-offset-1" style="height:400px"></div>
    </div>
</div>

<div class="container-fluid">
    <div class="row">
        <div id="patent_broken_line" class="col-md-12" style="height:400px"></div>
    </div>
</div>
